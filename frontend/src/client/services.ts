...
import {
    ...
    ItemsPublic,
    ItemUpdate,
    ClientPublic, RelationPublic, RelationsPublic, ClientCreate, ClientsPublic, ClientUpdate
} from './models';
...
export class ClientService {
    ...
    public static patchClient(id: number, data: ClientUpdate): CancelablePromise<ClientPublic> {
        return __request(OpenAPI, {
            method: 'PATCH',
            url: '/api/v1/clients/{client_id}',
            body: data,
    ...
    public static deleteClient(data: TDataReadClient): CancelablePromise<ClientPublic> {
        const {
            clientId,
        } = data;
        return __request(OpenAPI, {
    ...
    public static createClientsFromFile(formData: FormData, groupName: string): CancelablePromise<ClientPublic> {
        return __request(OpenAPI, {
            method: 'POST',
            url: `/api/v1/clients/file?group_name=${encodeURIComponent(groupName)}`,
            body: formData,
...
export class RelationService {
    ...
    public static deleteRelation(data: TDataReadRelation): CancelablePromise<ClientPublic> {
        const {
            relationId,
        } = data;
        return __request(OpenAPI, {
            method: 'DELETE',
            url: '/api/v1/relations/{relation_id}',
            path: {
